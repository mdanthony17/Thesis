...
With the differential scattering rate, we can predict the number of WIMPs of a given cross-section and mass we would expect to scatter in a detector of a certain size.  

\begin{equation}

Of course, the above equation does not account for detector constraints, which typically make it very difficult to probe the lowest energies.
...
% need to also mention size of detector
