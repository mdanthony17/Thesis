...
Oftentimes in physics, very complicated processes can be very well approximated by very simple and analytical probability distributions.  There are many examples of these useful approximations in this work alone, including the majority of the calibrations for XENON1T (\secref{sec:xe1t_calibrations}) and neriX (\secref{sec:nerix_cals}).
